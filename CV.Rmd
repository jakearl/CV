...
```{r}
intro_text <- "Pharmacist (PharmD) with clinical and payor expertise, and Health Economist (MS) with in-depth training in Health Economics and Outcomes Research (HEOR). 

I have worked for a Managed Care Organization, a research hospital, and multiple pharmaceutical companies. I have conducted various Real-World Evidence (RWE) studies utilizing advanced methods tailored to the aims, and have built and analyzed various economic models. My expertise includes biostatistics, epidemiology, modeling, and coding in multiple languages. My goal is to become a leader within my field by generating impactful research that depicts a clear message.
"
